...
flowchart TB
    ...
    style CorePlatform fill:#EFF6FC,stroke:#0078D4,stroke-width:2px,color:#323130
    style Inventory fill:#DFF6DD,stroke:#107C10,stroke-width:2px,color:#323130
    style SharedMon fill:#FFF4CE,stroke:#FFB900,stroke-width:2px,color:#323130
```
