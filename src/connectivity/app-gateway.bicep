...
module certificate '../security/certificate.bicep' = {
  name: 'certificate'
...
resource appGatewayPublicIPAddress 'Microsoft.Network/publicIPAddresses@2024-07-01' existing = {
  name: appGatewayPublicIpName
}

resource appgw_waf_Pol 'Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies@2024-07-01' = {
    ...
    sslCertificates: [
      {
        name: appGatewayFQDN
        properties: {
          keyVaultSecretId: certificate.outputs.AZURE_APP_GATEWAY_CERTIFICATE_URI
        }
      }
    ]
    sslPolicy: {
