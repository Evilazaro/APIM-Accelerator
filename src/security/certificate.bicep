...
resource accessPolicyGrantForCertificate 'Microsoft.KeyVault/vaults/accessPolicies@2024-11-01' = {
...
output AZURE_APP_GATEWAY_CERTIFICATE_URI string = appGatewaySecretsUri.outputs.AZURE_APP_GATEWAY_CERTIFICATE_URI
